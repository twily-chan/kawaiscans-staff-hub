...
export const INITIAL_STAFF: StaffMember[] = [
  {
    ...
    favManga: 'Bleach',
    hobbies: [{ name: 'Drawing', category: 'Creative' }, { name: 'Karaoke', category: 'Active' }],
    powerLevel: 9001,
    coffeeConsumption: 5
  },
  {
    ...
    hobbies: [{ name: 'Reading', category: 'Chill' }, { name: 'Tea Tasting', category: 'Chill' }],
    powerLevel: 8500,
    coffeeConsumption: 2
  },
  {
    ...
    favManga: 'One Piece',
    hobbies: [{ name: 'Digital Art', category: 'Creative' }, { name: 'Gaming', category: 'Tech' }],
    powerLevel: 7200,
    coffeeConsumption: 4
  },
  {
    ...
    favManga: 'Yotsuba&!',
    hobbies: [{ name: 'Typography', category: 'Creative' }, { name: 'Mechanical Keyboards', category: 'Tech' }],
    powerLevel: 6800,
    coffeeConsumption: 3
  }
];
